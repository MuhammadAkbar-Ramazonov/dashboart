        ...
        <ul className="mb-0 list-unstyled">
            <form>
                <div className="d-flex align-items-center justify-content-between py-3 mx-32">
                    <input className="diogram-task-input w-100 bg-transparent border-0" type="text" aria-label="Create new task" placeholder="Create new task" />
                    <button className="diogram-task-btn rounded-2 border-0">
            ...
            <DiogramTaskItem>
                <div className="d-flex align-items-center">
                    <input className="diogram-task-checkbox visually-hidden" type="checkbox" />
                    <span className="diogram-task-checkbox-box">
